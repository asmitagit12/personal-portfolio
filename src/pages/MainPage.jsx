  ...
  return (
    ...
    >
      ...
      <div className="lg:col-span-6 h-screen flex justify-center lg:justify-end ">
        <div className="w-full lg:w-[600px] h-full flex flex-col justify-center px-5 lg:px-10 space-y-8">
          {/* Heading Section */}
          <div className="flex flex-col lg:flex-row items-start lg:items-center space-y-2 lg:space-y-0 lg:space-x-3 animate-fadeInLeft">
            <h4 className="text-white text-2xl lg:text-3xl text-left">Hey, I'm</h4>
            <p className="text-4xl md:text-6xl lg:text-6xl font-semibold text-orange-400 text-left">
              Asmita Patil
            </p>
          </div>
          {/* Role Section */}
          <p className="text-white text-xl md:text-3xl lg:text-2xl animate-fadeInLeft delay-500">
          ...
          {/* Intro Section */}
          <div className="text-slate-100 space-y-4 animate-fadeInLeft text-md delay-700">
            <p>
          ...
          <div className="flex flex-col lg:flex-row gap-5 animate-fadeInUp delay-1000">
            <button
              className="relative w-full lg:w-1/2 bg-gradient-to-r from-orange-400 to-orange-600 text-white font-bold capitalize py-3 px-5 rounded-2xl transition-transform transform hover:scale-105 shadow-lg overflow-hidden"
            ...
            <button
              ...
              className="w-full lg:w-1/2 bg-gradient-to-r from-gray-300 to-gray-700 text-white capitalize py-3 px-5 rounded-2xl transition-transform transform hover:scale-105 shadow-lg hover:shadow-xl"
            >
              Projects
            </button>
          </div>
      ...
      <div className="lg:col-span-6 h-screen flex justify-center items-center lg:justify-center">
        <div className="relative w-[250px] md:w-[400px] lg:w-[400px] flex flex-col justify-center mt-10 lg:mt-0 animate-fadeInRight">
          ...
          <img
            src={whiteBg}
            alt="Profile"
            className="w-full h-[30rem] lg:h-[37rem] object-cover rounded-tl-[60px] rounded-br-[60px] transition-transform transform hover:scale-90 duration-500 absolute top-[1.5] right-[-4] left-2 lg:left-9 z-10"
          />
          ...
          <img
            src={myImg}
            alt="Profile"
            className="w-full h-[30rem] lg:h-[37rem] object-cover rounded-tl-[60px] rounded-br-[60px] transition-transform transform scale-95 duration-500 z-20 shadow-slate-900 hover:shadow-2xl hover:scale-100"
          />
