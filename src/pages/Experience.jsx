    ...
    <div className="pt-10 pb-10 pl-5 pr-5 md:pl-20 md:pr-20 bg-[#141414] min-h-screen">
      ...
      <ol className="relative border-s border-gray-200 ml-5 dark:border-orange-700">
        <li className="ms-4 mb-10">
          ...
          <h3 className="text-base md:text-lg font-semibold text-gray-900 dark:text-white">Suyotech Engineering Solutions Pv. Ltd. Kolhapur</h3>
          <h3 className="text-base md:text-lg font-semibold text-gray-900 dark:text-gray-300">Job Role : Frontend Developer</h3>
        ...
        <li className="mb-10 ms-4">
          ...
          <h3 className="text-base md:text-lg font-semibold text-gray-900 dark:text-white">PHN Technology Pvt Ltd, Pune</h3>
          <h3 className="text-base md:text-lg font-semibold text-gray-900 dark:text-gray-300">Role : Web Developer Intern</h3>
        ...
        <li className="mb-10 ms-4">
          ...
          <h3 className="text-base md:text-lg font-semibold text-gray-900 dark:text-white">Akron Systems, Kolhapur</h3>
          <h3 className="text-base md:text-lg font-semibold text-gray-900 dark:text-gray-300">Role : Frontend Developer Intern</h3>
